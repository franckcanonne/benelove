...
Ce logiciel utilise la bibliothèque libre dhtmlxGantt sur une base Node.js et Express. 
...
1. `npm install`
2. Creer la base de donnée et installer **schema.sql**
3. Modifier les données de connection dans **server.js**
